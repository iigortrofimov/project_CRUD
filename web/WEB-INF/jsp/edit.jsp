<%@ page import="project.webapp.model.ContactType" %>
<%@ page import="project.webapp.model.ExperienceSection" %>
<%@ page import="project.webapp.model.ListSection" %>
<%@ page import="project.webapp.model.SectionType" %>
<%@ page import="project.webapp.util.DateUtil" %>
                    ...
                    <c:forEach var="org" items="<%=((ExperienceSection) section).getExperiences()%>"
                        ...
                        <div style="margin-left: 30px">
                            <c:forEach var="pos" items="${org.positions}">
                                <jsp:useBean id="pos" type="project.webapp.model.Experience.Position"/>
                                <dl>
